...
type InsertScalar = string | number | boolean | null | undefined | Node;
type InsertScalarOrArray = InsertScalar | InsertScalar[] | (InsertScalar | InsertScalar[])[] | (InsertScalar | (InsertScalar | InsertScalar[])[])[]
type InsertValue = InsertScalarOrArray | (() => InsertValue);
