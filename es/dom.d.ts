...
export declare function setAttribute(node: Element, name: string, value: any): void;
export declare function setAttributeNS(node: Element, namespace: string, name: string, value: any): void;
